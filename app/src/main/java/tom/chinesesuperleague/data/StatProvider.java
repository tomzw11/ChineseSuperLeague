...
//            StatContract.PlayerEntry.TABLE_NAME+
//                    "." + StatContract.PlayerEntry.COLUMN_LOCATION_SETTING + " = ? ";
//
//    //location.location_setting = ? AND date >= ?
//    private static final String sLocationSettingWithStartDateSelection =
//            StatContract.PlayerEntry.TABLE_NAME+
//                    "." + StatContract.PlayerEntry.COLUMN_LOCATION_SETTING + " = ? AND " +
...
//        String locationSetting = StatContract.StatEntry.getLocationSettingFromUri(uri);
//        long startDate = StatContract.StatEntry.getStartDateFromUri(uri);
//
...
//        String locationSetting = StatContract.StatEntry.getLocationSettingFromUri(uri);
//        long date = StatContract.StatEntry.getDateFromUri(uri);
//
//        return sWeatherByLocationSettingQueryBuilder.query(mOpenHelper.getReadableDatabase(),
//                projection,
...
//        matcher.addURI(authority, StatContract.PATH_WEATHER, WEATHER);
//        matcher.addURI(authority, StatContract.PATH_WEATHER + "/*", WEATHER_WITH_LOCATION);
//        matcher.addURI(authority, StatContract.PATH_WEATHER + "/*/#", WEATHER_WITH_LOCATION_AND_DATE);
//
//        matcher.addURI(authority, StatContract.PATH_LOCATION, LOCATION);
//        return matcher;
//    }
//
//    /*
//        Students: We've coded this for you.  We just create a new StatDBHelper for later use
//        here.
//     */
//    @Override
...
//                if ( _id > 0 )
//                    returnUri = StatContract.StatEntry.buildWeatherUri(_id);
//                else
